    ...
    <div className="space-y-6 rounded-3xl border border-border/60 bg-background/70 p-8 shadow-[0_0_40px_rgba(15,23,42,0.08)] backdrop-blur-xl">
      <div className="space-y-2">
        ...
        <p className="max-w-2xl text-sm text-muted-foreground">
          Review current stock, delivery movements, and branch performance from
          one premium operations dashboard.
        </p>
      </div>
      <div className="flex flex-wrap gap-3">
        ...
        <Link
          ...
          className="rounded-full border border-border/60 px-4 py-2 text-sm font-medium text-foreground transition hover:bg-muted/60"
        >
